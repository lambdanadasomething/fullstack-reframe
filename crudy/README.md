...
* [`src/cljs/crudy/`](src/cljs/crudy/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/crudy/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `crudy` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/crudy/config.cljs) defaults to `true` in
...
```clj
(ns crudy.example
  (:require [crudy.config :as config])
